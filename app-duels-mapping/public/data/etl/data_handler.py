...
class DataHandler:
    def __init__(self, data_vars_path=data_vars_path):
        with open(data_vars_path, 'r') as f:
            ...
            # raw_path = os.path.join(data_vars["database"]["path"], self.database_name)
            # self.database_path = os.path.normpath(os.path.join(os.path.dirname(data_vars_path), raw_path))
